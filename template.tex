...
% To color some element, do this:
% \usepackage{xcolor}
% \definecolor{aliceblue}{rgb}{0.81, 0.89, 0.95}
% {
%     \color{aliceblue}
%     \thatelement
% }
% Or, can use present colors also, using `\color{red}` for example
% Can also use `\definecolor{aliceblue}{RGB}{200, 120, 255}` for normal RGB definition
...
% Credit: https://nw360.blogspot.com/2007/09/roman-numerals-in-latex.html
% Use this to render capital roman numerals
\makeatletter
